...
public class app {
    ...
    public void parseDishData() throws IOException{
        BufferedReader dishData=Files.newBufferedReader(Paths.get("C:\\Users\\garima saha\\IdeaProjects\\testproject\\out\\production\\testproject\\dish.csv"));
        String lines=null;
    ...
    public void parseRestroData() throws IOException{
        BufferedReader restroData=Files.newBufferedReader(Paths.get("C:\\Users\\garima saha\\IdeaProjects\\testproject\\out\\production\\testproject\\name.csv"));
        String lines=null;
